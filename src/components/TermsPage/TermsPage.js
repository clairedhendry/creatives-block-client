...
export default function Terms() {
    return (
        <div className="terms-container">
            ...
            <p>Creative's Block requires a user name, password, and email address to sign up.</p>
            <p>Your information is securely stored and will never be made available to third parties without your consent.</p>
            ...
            In using Creative's Block you verify that content uploaded by you is owned by you.
            If a user is discovered to be uploading content that they do not own, their account will be terminated.
            If you suspect a user has uploaded content that is not their own, or done so without permission, please email us at creatives.block@gmail.com</p>
            <h3>On Content</h3>
